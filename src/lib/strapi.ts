...
// Note: les helpers serveur (getProfilAdoptant, updateProfilAdoptant,
// getMesDemandes, getMesFavoris) vivent dans `./strapi-server.ts` car ils
// utilisent `next/headers` (cookies) qui n'est dispo qu'en server-only.
