      ...
      {demandes.length === 0 ? (
        ...
        <ul className="mt-10 space-y-5">
          {demandes.map((d) => {
            ...
            return (
              <li key={d.id}>
                <article className="rounded-2xl bg-surface p-4 ring-1 ring-border md:p-5">
                  <div className="flex gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <span
                          className={`shrink-0 rounded-full px-2.5 py-0.5 text-xs font-semibold ${statut.cls}`}
                        >
                          {statut.label}
                        </span>
                      </div>
                  ...
                  {profil ? (
                    <details className="mt-3 rounded-lg bg-bg-alt p-3">
                      <summary className="cursor-pointer text-xs font-semibold uppercase tracking-wider text-primary-dark">
